...
function PANEL:AddNode( strName, strIcon )
	...
	local pNode = vgui.Create( "DTree_Node_Midi", self )
...
function PANEL:Copy()
	...
	local copy = vgui.Create( "DTree_Node_Midi", self:GetParent() )
...
derma.DefineControl( "DTree_Node_Midi", "Tree Node", PANEL, "DPanel" )
